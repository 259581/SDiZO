...
int main() {
/* DOOROBIC PRZEZ ZLICZANIE, ANIMACJA, GENERALNIE ZROBIC DLA O(n) */
    ...
    switch(choice){
        ...
        case 2:
            ...
            break;
        case 3:
            printf("You have chosen counting-sort\n");
            workingLoop(stoi(configs[4]), array,configs[0], configs[3], countingSort, firstInstance);
            break;
        default:
